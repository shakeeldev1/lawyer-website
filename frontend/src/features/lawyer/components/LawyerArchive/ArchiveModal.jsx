// src/components/ArchiveComponents/ArchiveModal.jsx
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
      ...
      <div className="relative bg-white w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl shadow-xl z-10">
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-t-2xl px-5 sm:px-6 py-4 sm:py-5">
        ...
        {/* Case Meta */}
        <div className="bg-gray-50 border-b border-gray-200 px-5 sm:px-6 py-3 text-sm text-gray-600 flex flex-wrap gap-4 justify-between">
        ...
        {/* Footer */}
        <div className="sticky bottom-0 bg-white border-t border-gray-200 rounded-b-2xl px-5 sm:px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-3">
          <div className="text-xs sm:text-sm text-gray-600 text-center sm:text-left">
            Total: {caseData.stages.length} legal stage
            {caseData.stages.length !== 1 ? "s" : ""} archived
          </div>
