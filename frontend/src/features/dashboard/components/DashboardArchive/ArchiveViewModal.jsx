            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                <div className="sticky top-0 bg-white border-b border-slate-200 p-6 rounded-t-2xl">
                    <div className="flex items-center justify-between">
                        <h3 className="text-xl font-bold text-slate-800">Archived Case Details</h3>
                        <button
                ...
                <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            <div>
                                <label className="text-sm font-medium text-slate-600">Archive ID</label>
                                <p className="text-lg font-semibold text-slate-800">{archive.archiveId}</p>
                            </div>
                            <div>
                                <label className="text-sm font-medium text-slate-600">Case ID</label>
                                <p className="text-lg font-semibold text-blue-600">{archive.id}</p>
                            </div>
                            <div>
                                <label className="text-sm font-medium text-slate-600">Client Name</label>
                                <p className="text-lg font-semibold text-slate-800">{archive.client}</p>
                            </div>
                            <div>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-lg font-semibold text-slate-800">{archive.lawyer}</p>
                            </div>
                            <div>
                                <label className="text-sm font-medium text-slate-600">Submitted On</label>
                                <p className="text-lg font-semibold text-slate-800">{archive.submittedOn}</p>
                            </div>
                            <div>
                                <label className="text-sm font-medium text-slate-600">Status</label>
                                <p className="text-lg font-semibold">
                                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusColor(archive.status)}`}>
                                        {archive.status}
                                    </span>
                                </p>
                            </div>
