...
const Topbar = () => {
  ...
  return (
  <header className="fixed top-0 left-72 right-0 h-20 bg-gradient-to-r from-slate-800 to-slate-900 shadow-2xl border-b border-slate-700 flex items-center justify-between px-8 z-50 transition-all duration-300">
  {/* Left Section - Branding or Page Title */}
  <div className="flex items-center gap-4">
    {/* You can place breadcrumb or page title here */}
  </div>
